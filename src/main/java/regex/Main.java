...
public class Main {
    ...
    public static List<String> extractEmails(String str) {
        ...
        // Match one or more characters before '@' and restrict domain to
        // mail.utoronto.ca or utoronto.ca
    ...
    public static boolean checkForDoubles(String str) {
        ...
        // Check if the same capital letter appears at least twice anywhere in the string
